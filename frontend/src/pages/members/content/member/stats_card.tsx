    ...
    <div className="shadow card">
      <div className="card-body text-center text-dark">
        <div className="row">
          <div className="col-4">
            <div className="border-bottom border-5 border-primary">
              <h5 className="text-muted mt-1 mb-2 fw-normal"><i className="px-2 bi bi-trophy-fill"></i>Trophy</h5>
          ...
          <div className="col-4">
            <div className="border-bottom border-5 border-warning">
              <h5 className="text-muted mt-1 mb-2 fw-normal"><i className="px-2 bi bi-gift-fill"></i>Gift</h5>
              <h2 className="mb-0 fw-bold">{millify(0)}</h2>
            </div>
          </div>
        </div>
